...
export default function Create(props) {
    const { aset_mutasi, ruangans, detail_aset_mutasi } = usePage().props;
                                ...
                                <div className="mb-3">
                                    ...
                                    <div className="flex  w-full ">
                                        <TextInput
                                            ...
                                            type="text"
                                            value={kode.kode}
                                            className="block w-full h-full rounded-r-none bg-gray-100"
                                            isFocused={true}
                                            readonly={true}
                                        />
                                        <label
