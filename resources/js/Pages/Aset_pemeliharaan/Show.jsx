...
export default function Create(props) {
    const { aset_pemeliharaan, ruangans, detail_aset_pemeliharaans, auth } =
        usePage().props;

    const [enabled, setEnabled] = useState(aset_pemeliharaan.verifikasi);
    ...
    const { data, setData, post } = useForm({
        aset_pemeliharaan_id: aset_pemeliharaan.id,
        detail_aset_id: "",
        kondisi: "",
    });
    ...
    const handleDelete = (id) => {
        confirm("apakah anda yakin ingin menghapus?") &&
            Inertia.delete(`/destroy_detail_pemeliharaan/${id}`);
    };

    const verifyData = () => {
        const bol = aset_pemeliharaan.verifikasi ? 0 : 1;
        Inertia.put(`/aset_pemeliharaan/${aset_pemeliharaan.id}`, {
            verifikasi: bol,
        });
        setEnabled(bol);
    };
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post("/store_detail_pemeliharaan");
        setKode({
            kode: "",
        });
                        ...
                        <div className="bg-white">
                            <div className="p-5 flex">
                                <div className="w-11/12">
                                    {/* Tabel keterangan */}
                                    <KeteranganEl
                                        asetPenghapusan={aset_pemeliharaan}
                                    />
                                </div>
...
const FormAsetPenghapusan = ({
    ...
    return (
        <div className="bg-white w-full md:w-2/6 shadow-sm sm:rounded-lg m-2">
            <div className="p-5">
                <h1 className="text-2xl mb-3">Form Aset Pemeliharaan</h1>
            ...
            <table>
                <tbody>
                    <tr>
                        ...
                        <td> : {asetPenghapusan.kode_pemeliharaan}</td>
                    </tr>
                    <tr>
                        <td className="pr-3">Tanggal Aset Pemeliharaan</td>
                        <td>: {asetPenghapusan.tanggal_pemeliharaan}</td>
                    </tr>
                    <tr>
                        <td>verifikasi</td>
                        <td>
